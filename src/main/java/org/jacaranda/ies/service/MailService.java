...
public class MailService {
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        if (!mailEnabled) {
            log.info("Email delivery is disabled; skipping email");
            return;
        }
        log.debug("Sending email [multipart={}, html={}]", isMultipart, isHtml);
        ...
        try {
            ...
            log.warn("Email could not be sent [type={}]", e.getClass().getSimpleName());
        }
    }
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        if (user.getEmail() == null) {
            log.debug("Email address is unavailable for user");
            return;
        }
